...
for index in range(2000, 2100):  # 这个循环只会执行一次
    try:
        file_pattern = os.path.join('original_data/Shanghai_T2DM/', f'{index}*.xlsx')
        ...
        for filename in all_file_names:
            try:
                print(filename)
                workbook = openpyxl.load_workbook("original_data/Shanghai_T2DM/" + filename)
                ...
                workbook.save("generated_data/Shanghai_T2DM/" + filename)
